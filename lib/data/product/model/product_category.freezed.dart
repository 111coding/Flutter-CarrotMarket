...
abstract class $ProductCategoryCopyWith<$Res> {
  ...
  $Res call({int idx, String category});
}
...
class _$_ProductCategory implements _ProductCategory {
  const _$_ProductCategory({required this.idx, required this.category});
  ...
  @override
  String toString() {
    return 'ProductCategory(idx: $idx, category: $category)';
  }
...
abstract class _ProductCategory implements ProductCategory {
  const factory _ProductCategory(
      ...
      required final String category}) = _$_ProductCategory;
